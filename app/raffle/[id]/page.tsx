  ...
  return (
    <div className="px-6 py-10">
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        <span className="font-mono text-[10px] px-2.5 py-1 border border-black rounded-full ml-4 mt-1 flex-none">
          ● Live
        </span>
      </div>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={step} className="flex items-start gap-3 py-2.5 border-b border-gray-100 last:border-0">
              <span className="font-mono text-[11px] text-gray-400 flex-none mt-0.5">{step}</span>
